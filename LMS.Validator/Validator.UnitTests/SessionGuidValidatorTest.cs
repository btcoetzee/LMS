namespace LMS.Validator.UnitTests
{
    ...
    using System.Text;
    [TestClass]
    public class SessionGuidValidatorTest
    {
        ...
        /// </summary>
        [TestMethod]
        public void ValidSessionGuidValidator()
        {
            ...
            var sessionGuidValidator = new SessionGuidValidator();

            var actualValue = sessionGuidValidator.ValidLead(_testLeadEntity);
        ...
        /// </summary>
        [TestMethod]
        public void InvalidSessionGuidValidatorKey()
        {
        ...
        /// </summary>
        [TestMethod]
        public void InvalidSessionGuidValueValidator()
        {

            _testLeadEntity.Context = new IContext[] { new DefaultContext(Modules.LeadEntity.Interface.Constants.ContextKeys.SessionGuidKey, 5) };
            var sessionGuidValidator = new SessionGuidValidator();
        ...
        [TestMethod]
        public void NullSessionGuidValueValidator()
        {

            _testLeadEntity.Context = new IContext[] { new DefaultContext(Modules.LeadEntity.Interface.Constants.ContextKeys.SessionGuidKey, null) };
            var sessionGuidValidator = new SessionGuidValidator();
