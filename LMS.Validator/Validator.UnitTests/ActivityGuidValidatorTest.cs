namespace LMS.Validator.UnitTests
{
    ...
    public class ActivityGuidValidatorTest
    {
        ...
        public void InvalidActivityGuidValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(Modules.LeadEntity.Interface.Constants.ContextKeys.ActivityGuidKey, 5) };
            var activityGuidValidator = new ActivityGuidValidator();
        ...
        public void NullActivityGuidValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(Modules.LeadEntity.Interface.Constants.ContextKeys.ActivityGuidKey, null) };
            var activityGuidValidator = new ActivityGuidValidator();
