namespace LMS.Validator.UnitTests
{
    ...
    public class PriorBIValidatorTest
    {
        ...
        public void ValidPriorBIValidator()
        {
            ...
            _testLeadEntity.Properties = new IProperty[] { new DefaultProperty(Modules.LeadEntity.Interface.Constants.PropertyKeys.PriorBIKey, "100/300") };
        ...
        public void InvalidPriorBIValueValidator()
        {
            ...
            _testLeadEntity.Properties = new IProperty[] { new DefaultProperty(Modules.LeadEntity.Interface.Constants.PropertyKeys.PriorBIKey, "") };
            var priorBIValidator = new PriorBIValidator();
