namespace LMS.Validator.UnitTests
{
    ...
    public class EnvironmentValidatorTest
    {
        ...
        public void InvalidQuotedProductValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(Modules.LeadEntity.Interface.Constants.ContextKeys.EnvironmentKey, "") };
            var environmentValidator = new EnvironmentValidator();
        ...
        public void NullQuotedProductValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(Modules.LeadEntity.Interface.Constants.ContextKeys.EnvironmentKey, null) };
            var environmentValidator = new EnvironmentValidator();
