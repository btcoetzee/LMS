namespace LMS.Validator.UnitTests
{
    ...
    public class PriorInsuranceIndicatorValidatorTest
    {
        ...
        public void InvalidPriorInsuranceValueValidator()
        {
            ...
            _testLeadEntity.Properties = new IProperty[] { new DefaultProperty(Modules.LeadEntity.Interface.Constants.PropertyKeys.PriorInsuranceKey, 8) };
            var priorInsuranceValidator = new PriorInsuranceValidator();
        ...
        public void NullPriorInsuranceValueValidator()
        {
            ...
            _testLeadEntity.Properties = new IProperty[] { new DefaultProperty(Modules.LeadEntity.Interface.Constants.PropertyKeys.PriorInsuranceKey, null) };
            var priorInsuranceValidator = new PriorInsuranceValidator();
