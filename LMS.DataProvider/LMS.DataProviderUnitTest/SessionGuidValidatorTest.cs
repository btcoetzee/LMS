namespace LMS.DataProviderUnitTest
{
    ...
    public class SessionGuidValidatorTest
    {
        ...
        public void InvalidSessionGuidValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(LeadEntity.Interface.Constants.ContextKeys.SessionGuidKey, 5) };
            var sessionGuidValidator = new SessionGuidValidator();
        ...
        public void NullSessionGuidValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(LeadEntity.Interface.Constants.ContextKeys.SessionGuidKey, null) };
            var sessionGuidValidator = new SessionGuidValidator();
