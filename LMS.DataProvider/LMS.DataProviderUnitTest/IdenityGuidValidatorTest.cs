namespace LMS.DataProviderUnitTest
{
    ...
    public class IdentityGuidValidatorTest
    {
        ...
        public void InvalidIdentityGuidtValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(LeadEntity.Interface.Constants.ContextKeys.IdentityGuidKey, 5) };
            var identityGuidValidator = new IdentityGuidValidator();
        ...
        public void NullIdentityGuidValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(LeadEntity.Interface.Constants.ContextKeys.IdentityGuidKey, null) };
            var identityGuidValidator = new IdentityGuidValidator();
