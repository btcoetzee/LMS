namespace LMS.DataProviderUnitTest
{
    ...
    public class AdditionalProductsValidatorTest
    {
        ...
        public void ValidAdditionalProductsValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(LeadEntity.Interface.Constants.ContextKeys.AdditionalProductKey, 104) };
        ...
        public void NullAdditionalProductsValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(LeadEntity.Interface.Constants.ContextKeys.AdditionalProductKey, null) };
            var additionalProductsValidator = new AdditionalProductsValidator();
