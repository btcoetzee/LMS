namespace LMS.DataProviderUnitTest
{
    ...
    public class SiteIdValidatorTest
    {
        ...
        public void InvalidSiteIdValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(LeadEntity.Interface.Constants.ContextKeys.SiteIDKey, Guid.NewGuid().ToString()) };
            var siteIdValidator = new SiteIdValidator();
        ...
        public void NullSiteIdValueValidator()
        {
            ...
            _testLeadEntity.Context = new IContext[] { new DefaultContext(LeadEntity.Interface.Constants.ContextKeys.SiteIDKey, null) };
            var siteIdValidator = new SiteIdValidator();
