        ...
        public List<IResult> ProcessLead(ILeadEntityImmutable leadEntity)
        {
            ...
            if (_buyClickValidator.ValidLead(leadEntity).Equals(true))
            {
                ...
                if (_buyClickFilter.ClearedFilter(leadEntity))
                {
                    ...
                    _loggerClient.Log(new DefaultLoggerClientObject { OperationContext = $"Check Campaign Rules {CampaignName} ", ProcessContext = processContext, SolutionContext = solutionContext });
                    // Check Rules
                    ...
                    else
                    {
                        ...
                        _loggerClient.Log(new DefaultLoggerClientObject { OperationContext = "Rule Failed", ProcessContext = processContext, SolutionContext = solutionContext });
                    }
