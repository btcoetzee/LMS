namespace LMS.Campaign.BuyClick.Validator
{
    ...
    public class BuyClickValidator : ICampaignValidator
    {
        ...
        public bool ValidLead(ILeadEntityImmutable leadEntity)
        {
            ...
            {
                _loggerClient.Log(new DefaultLoggerClientErrorObject{OperationContext = "\nValidating Phone Number and PNI Age",ProcessContext = processContext,SolutionContext = solutionContext,Exception = ex,ErrorContext = ex.Message, EventType = LoggerClientEventTypeControl.Interface.Constants.LoggerClientEventType.LoggerClientEventTypes.Error});
                return false;
            }
