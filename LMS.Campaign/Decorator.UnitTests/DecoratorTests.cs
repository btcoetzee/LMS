namespace Decorator.UnitTests
{
    ...
    public class DecoratorTests
    {
        ...
        public void TestDecoratorApplied()
        {
            ...
            const string decoratedLeadMessage = leadMessage + " Decoration";
            ...
            //var lead = new MemoryStream(Convert.FromBase64String(leadMessage));
            //var decoration = new MemoryStream(Convert.FromBase64String(decorationMessage));
            ...
            Assert.IsTrue(decoratedLead.Contains(leadMessage));
            Assert.IsTrue(decoratedLead.Contains(decorationMessage));
        }
    }
}
